...
<gameSystem id="c372-4887-df6a-ad9e" name="Marvel Universe Miniature Game" revision="1" battleScribeVersion="2.01" authorName="NeXo" authorUrl="http://labibliotecadealfred.blogspot.com.es/" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <profiles/>
  <rules/>
  <infoLinks/>
  <costTypes>
  ...
  <categoryEntries>
    <categoryEntry id="8e5643b0-fa24-83db-e4f2-1622a0ee32b4" name="Superhuman Heroes (Marvel)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <categoryEntry id="574c-53a7-facd-188b" name="Mutant Heroes (Marvel)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <categoryEntry id="dbf6-0f63-203c-eb6c" name="Cosmic Heroes (Marvel)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <categoryEntry id="4e20-4037-aa69-dde0" name="Superhuman Villains (Marvel)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <categoryEntry id="2699-16b6-defe-349e" name="Mutant Villains (Marvel)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <categoryEntry id="9861-047c-a40f-d279" name="Cosmic Villains (Marvel)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
  ...
  <forceEntries>
    <forceEntry id="4e5b49d8-1fef-164b-8bd7-0bee9ad46f2f" name="Characters" hidden="false">
      ...
      <forceEntries/>
      <categoryLinks>
        <categoryLink id="0702-7507-71ad-a69f" name="Superhuman Heroes (Marvel)" hidden="false" targetId="8e5643b0-fa24-83db-e4f2-1622a0ee32b4" primary="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryLink id="4e5b49d8-1fef-164b-8bd7-0bee9ad46f2f-574c-53a7-facd-188b" name="Mutant Heroes (Marvel)" hidden="false" targetId="574c-53a7-facd-188b" primary="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryLink id="4e5b49d8-1fef-164b-8bd7-0bee9ad46f2f-dbf6-0f63-203c-eb6c" name="Cosmic Heroes (Marvel)" hidden="false" targetId="dbf6-0f63-203c-eb6c" primary="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryLink id="4e5b49d8-1fef-164b-8bd7-0bee9ad46f2f-4e20-4037-aa69-dde0" name="Superhuman Villains (Marvel)" hidden="false" targetId="4e20-4037-aa69-dde0" primary="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryLink id="4e5b49d8-1fef-164b-8bd7-0bee9ad46f2f-2699-16b6-defe-349e" name="Mutant Villains (Marvel)" hidden="false" targetId="2699-16b6-defe-349e" primary="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryLink id="4e5b49d8-1fef-164b-8bd7-0bee9ad46f2f-9861-047c-a40f-d279" name="Cosmic Villains (Marvel)" hidden="false" targetId="9861-047c-a40f-d279" primary="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
...
The character may not end their movement in a space occupied by other character. Mark the exact position of the miniature with a counter.</description>
    ...
    <rule id="5155-2d8c-3192-6c99" name="Awkwardness/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Energy Defense of the target by 1 point till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    <rule id="2229-c318-dd67-348a" name="Dazzle/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Mental Defense of the target by 2 points till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    ...
    <rule id="eafa-737e-a455-9029" name="Ensnare/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Speed of the target by 1 point till the end of the Round. If the Speed value is reduced to 0, the target character cannot move. This effect can stack.</description>
    </rule>
    <rule id="d861-993e-3575-37c9" name="Explosive/3 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this attack successfully hits, the attack affects an area with a radius of 3” centered on the base of the target. Each model affected, friend or foe, within that radius in all directions is hit automatically. Models within the explosive area (but not the original target) may make an Agility roll. If this roll is passed, they receive only half damage from the attack, rounding fractions down (to a minimum of 1 point of damage).</description>
    </rule>
    <rule id="3343-98d7-367c-5d89" name="Stun/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Remove 2 Power counters from the target, to a minimum of 0. This effect can stack.</description>
    </rule>
    <rule id="d802-bc9e-bc31-5feb" name="Stun/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Remove 1 Power counter from the target, to a minimum of 0. This effect can stack.</description>
    </rule>
    <rule id="456a-680c-1bcd-f6bd" name="Stun/3 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Remove 3 Power counters from the target, to a minimum of 0. This effect can stack.</description>
    </rule>
    ...
    <rule id="77d6-1515-64c4-d898" name="Explosive/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this attack successfully hits, the attack affects an area with a radius of 1” centered on the base of the target. Each model affected, friend or foe, within that radius in all directions is hit automatically. Models within the explosive area (but not the original target) may make an Agility roll. If this roll is passed, they receive only half damage from the attack, rounding fractions down (to a minimum of 1 point of damage).</description>
    </rule>
    <rule id="2152-5aea-3072-f8a3" name="Explosive/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this attack successfully hits, the attack affects an area with a radius of 2” centered on the base of the target. Each model affected, friend or foe, within that radius in all directions is hit automatically. Models within the explosive area (but not the original target) may make an Agility roll. If this roll is passed, they receive only half damage from the attack, rounding fractions down (to a minimum of 1 point of damage).</description>
    </rule>
    <rule id="a10d-1fd2-af59-3381" name="Ensnare/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Speed of the target by 2 points till the end of the Round. If the Speed value is reduced to 0, the target character cannot move. This effect can stack.</description>
    </rule>
    <rule id="d163-c84c-4a20-6f12" name="Ensnare/3 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Speed of the target by 3 points till the end of the Round. If the Speed value is reduced to 0, the target character cannot move. This effect can stack.</description>
    </rule>
    <rule id="419f-268e-83d3-e18d" name="Distract/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Physical Defense of the target by 1 points till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    <rule id="1626-30c3-de06-f1e7" name="Distract/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Physical Defense of the target by 2 points till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    <rule id="f263-5d01-ca0d-1f98" name="Push/6 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Displace the affected miniature directly away from the attacker along the trajectory of the attack 6 inches, stopping if it comes into contact with something. If it comes into contact with something both the model and the item (it could be another model or scenery) receive 1 damage Physical/Blunt.</description>
    </rule>
    <rule id="c1f8-29c3-5714-9be5" name="Push/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Displace the affected miniature directly away from the attacker along the trajectory of the attack 1 inches, stopping if it comes into contact with something. If it comes into contact with something both the model and the item (it could be another model or scenery) receive 1 damage Physical/Blunt.</description>
    </rule>
    <rule id="a40c-b0f1-944c-695e" name="Push/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Displace the affected miniature directly away from the attacker along the trajectory of the attack 2 inches, stopping if it comes into contact with something. If it comes into contact with something both the model and the item (it could be another model or scenery) receive 1 damage Physical/Blunt.</description>
    </rule>
    <rule id="f573-dbad-63a9-0c64" name="Push/3 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Displace the affected miniature directly away from the attacker along the trajectory of the attack 3 inches, stopping if it comes into contact with something. If it comes into contact with something both the model and the item (it could be another model or scenery) receive 1 damage Physical/Blunt.</description>
    </rule>
    <rule id="145c-cc16-45fc-08f8" name="Push/4 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Displace the affected miniature directly away from the attacker along the trajectory of the attack 4 inches, stopping if it comes into contact with something. If it comes into contact with something both the model and the item (it could be another model or scenery) receive 1 damage Physical/Blunt.</description>
    </rule>
    <rule id="c544-6236-59fc-4b5b" name="Push/5 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Displace the affected miniature directly away from the attacker along the trajectory of the attack 5 inches, stopping if it comes into contact with something. If it comes into contact with something both the model and the item (it could be another model or scenery) receive 1 damage Physical/Blunt.</description>
    </rule>
    ...
    <rule id="d73f-f099-6978-2be0" name="Dazzle/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Mental Defense of the target by 1 point till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    <rule id="471f-e2f8-a7c5-e982" name="Awkwardness/2 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Energy Defense of the target by 2 points till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    <rule id="c439-c18a-859f-ba3e" name="Pierce/1 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When using this attack, continue measuring the line of the shot 1 inch beyond the target. This attack damages the target and other models or scenery in a dead straight line behind it, up to 1”. Note: You still roll to hit additional Targets.</description>
    </rule>
...
This bonus doesn’t Stack.</description>
    ...
    <rule id="fc2c-f38d-c9b1-2aff" name="Explosive/4 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this attack successfully hits, the attack affects an area with a radius of 4” centered on the base of the target. Each model affected, friend or foe, within that radius in all directions is hit automatically. Models within the explosive area (but not the original target) may make an Agility roll. If this roll is passed, they receive only half damage from the attack, rounding fractions down (to a minimum of 1 point of damage).</description>
    </rule>
    ...
    <rule id="58fb-7678-af26-3a77" name="Explosive/6 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this attack successfully hits, the attack affects an area with a radius of 6” centered on the base of the target. Each model affected, friend or foe, within that radius in all directions is hit automatically. Models within the explosive area (but not the original target) may make an Agility roll. If this roll is passed, they receive only half damage from the attack, rounding fractions down (to a minimum of 1 point of damage).</description>
    </rule>
    <rule id="10f0-dbf6-c4a7-2872" name="Explosive/5 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this attack successfully hits, the attack affects an area with a radius of 5” centered on the base of the target. Each model affected, friend or foe, within that radius in all directions is hit automatically. Models within the explosive area (but not the original target) may make an Agility roll. If this roll is passed, they receive only half damage from the attack, rounding fractions down (to a minimum of 1 point of damage).</description>
    </rule>
    <rule id="1ceb-bbe6-db6c-eec9" name="Ensnare/5 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Speed of the target by 5 points till the end of the Round. If the Speed value is reduced to 0, the target character cannot move. This effect can stack.</description>
    </rule>
    ...
    <rule id="c9b0-8361-d5fb-840f" name="Distract/3 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Physical Defense of the target by 3 points till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    ...
    <rule id="b509-1c64-951f-1eab" name="Dazzle/3 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reduce the Mental Defense of the target by 3 points till the end of the Round or the next activation of the target, whichever comes first. This effect can stack.</description>
    </rule>
    ...
    <rule id="c292-8672-5de3-d0fe" name="Stun/4 (Effect)" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Remove 4 Power counters from the target, to a minimum of 0. This effect can stack.</description>
    </rule>
    ...
    <rule id="68b3-3df2-9b41-be30" name="Symbiote" page="0" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>This model has Weakness to Sonic and Regeneration 1. This character can reroll one Stamina roll each Round.</description>
    </rule>
    <rule id="3442-e700-a113-52d7" name="Toughness / 3" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="c17d-4ce9-ef77-5b4a" name="Resistance /1 to Mental" page="0" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When this character suffers any kind of damage of the Mental Nature, it is reduced by 1 point.</description>
    </rule>
  </sharedRules>
  <sharedProfiles>
